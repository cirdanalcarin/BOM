...
function showHomePage() {
    ...
    head2.appendChild(document.createTextNode("CATEGORIAS"));
...
function showActor() {
    ...
    while (actor.done !== true) {
        if (actor.value.name === this.value) {
            ...
            text2.appendChild(document.createTextNode("Birth Date: " + actor.value.born.toLocaleDateString('en-En', options)));
...
function showDirector() {
    ...
    while (director.done !== true) {
        if (director.value.name === this.value) {
            ...
            actBody.appendChild(text2);
            var options = { weekday: "long", year: "numeric", day: "numeric", month: "long" };
            text2.appendChild(document.createTextNode("Birth Date: " + director.value.born.toLocaleDateString('en-En', options)));
